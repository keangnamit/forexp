...
public class MailTest {
	 public void sendEmail(String from, String to, String cc, String subject, String content)
			  ...
			  //props.put("mail.smtp.host", "smtp.gmail.com");// gmail SMTP 서비스 주소(호스트)
			  //props.put("mail.smtp.port", "465");// gmail SMTP 서비스 포트 설정
			  props.put("mail.smtp.host", "192.168.4.13");// gmail SMTP 서비스 주소(호스트)
			  props.put("mail.smtp.port", "25");// gmail SMTP 서비스 포트 설정
	 ...
	 public void sendEmail(String from, String to, String cc, String subject, String content, String id, String pw)
			  throws Exception {
			  ...
			  SMTPAuthenticator auth2 = new SMTPAuthenticator();
			  auth2.setUsername(id);
			  auth2.setPassword(pw);
